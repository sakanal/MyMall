...
public class Oauth2Controller {
    @Autowired
    private MemberClient memberFeignService;

    @GetMapping("/oauth2.0/weibo/success")
    public String weibo(@RequestParam("code") String code, HttpSession session) throws Exception {
        String url = "https://api.weibo.com/oauth2/access_token?client_id=1411893798&client_secret=6b03671f1d5bd30edcd63f029a38a428&grant_type=authorization_code&redirect_uri=http://auth.gulimall.com:9001/oauth2.0/weibo/success&code=" +code;
        ...
        if (response.getStatusLine().getStatusCode()==200){
            ...
            return "redirect:http://gulimall.com:9001/login.html";
        }
