        ...
        <div class="header_banner">
          <div class="header_main_left">
            <ul>
              ...
              <li class="header_li2">
                <a href="#" class="header_main_left_a" ctg-data="11,13,10,15"><b>鞋</b> / <b>箱包</b> / <b>钟表</b> /
                  <b>珠宝</b></a>
              ...
              <li class="header_li2">
                <a href="#" class="header_main_left_a" ctg-data="14,20"><b>食品</b> / <b>酒类</b> / <b>生鲜</b> /
                  <b>特产</b></a>
...
<script>
import '../static/index/css/swiper-3.4.2.min.css'
import '../static/index/css/GL.css'
import '../static/index/js/jquery-3.1.1.min'
import '../static/index/js/swiper-3.4.2.jquery.min'
import '../static/index/js/text'
import '../static/index/js/header'
import '../static/index/js/secend'
import '../static/index/js/zz'
import '../static/index/js/index'
import '../static/index/js/left,top'
import '../static/index/js/catalogLoader'
