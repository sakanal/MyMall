package com.sakanal.member.interceptor;
...
public class LoginUserInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        //获取登录的用户信息
        MemberEntity entity = (MemberEntity) request.getSession().getAttribute(SESSION_LOGIN_KEY);

        if (entity != null) {
            MemberRespVo attribute = new MemberRespVo();
            BeanUtils.copyProperties(entity,attribute);
